...
define(function(require, exports, module) {
    ...
    function NavigationBar(options) {
        ...
        if(this.options.moreSurfaces){
            ...
            // Use default
            var tmpMoreWidth = false;
            if(this.options.moreContent === false){
                tmpMoreWidth = 20; // same as tmpBackWidth
            }
            this.more = this.options.more || new Surface({
                size: [tmpMoreWidth ? tmpMoreWidth:this.options.size[1] , this.options.size[1]],
