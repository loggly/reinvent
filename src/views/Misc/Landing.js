...
define(function(require, exports, module) {
    ...
    PageView.prototype.createFooter = function(){
        ...
        this.signupButton.on('click', function(){
            ...
            var ref = window.open('https://angel.co/api/oauth/authorize?scope=email&client_id='+App.Credentials.angelco_oauth_client_id+'&response_type=code', '_blank', 'location=no,toolbar=no');
            ...
            ref.addEventListener('loadstart', function(e){
                ...
                var code = url.url_query('code');
                if(code){
                    ref.close();

                    Utils.Notification.Toast('POSTing for access_token');
                    $.ajax({
                        url: 'https://angel.co/api/oauth/token',
                        data: {
                            client_id: App.Credentials.angelco_oauth_client_id,
                            client_secret: App.Credentials.angelco_oauth_client_secret,
                            code: code,
                        ...
                        success: function(){
                            Utils.Notification.Toast('success again');

                            // Send this to our server for logging in
                            // - ?? 
